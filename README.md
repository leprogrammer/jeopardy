...
Personal project to exercise setting up an AI tooling ecosystem with multiple models and tools. Implementation Plan generated by Claude Opus 4.6 in Antigravity. Implemented locally using VSCode Copilot with qwen3.8:27b running via Ollama. The ponytail Agent Skill and the hallmark Agent Skill were utilized to review the codebase and visual design.
